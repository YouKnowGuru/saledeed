...
interface SellerLocationSectionProps {
...
export function SellerLocationSection({ value, onChange, onNext, onBack }: SellerLocationSectionProps) {
  ...
  return (
    <FormStepSection
      headline={['WHERE IS THE', 'SELLER', 'LOCATED?']}
    >
      <div className="space-y-5">
        ...
        <p className="text-sm text-[#6B7280] dark:text-gray-400">
          This will appear in the deed as the seller's address.
        </p>
